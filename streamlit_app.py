...
if st.button("Analyze Company"):
    if company_url:
        ...
        summary_prompt = f"I'm a VC. I want to draft an email to an entrepreneur that illustrates that I'm knowledgeable about his business, the market and industry context his business operates in, how the business differentiates vs. its competitors, what customers are saying about his business, and any recent news or key developments around his business I might congratulate him on. Base this on the following information:" + "\n\n".join(step_results)
